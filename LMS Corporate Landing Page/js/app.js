...
class ContactPopup {
    ...
    init() {
        ...
        // Sign In button now links directly to LMS Corporate platform
...
class AppState {
    ...
    updateLanguageContent() {
        ...
        // Update hero image (same image for both languages)
...
document.addEventListener('visibilitychange', () => {
    if (document.hidden) {
        // Page is hidden
        document.title = '👋 Come back to MARLN Corporate LMS';
    } else {
        // Page is visible
        document.title = 'MARLN Corporate LMS - Your University. Simplified.';
    }
});
