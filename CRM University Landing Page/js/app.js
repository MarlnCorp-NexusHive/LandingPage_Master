...
class ContactPopup {
    ...
    init() {
        ...
        // Sign In button now links directly to CRM University platform
...
class AppState {
    ...
    updateLanguageContent() {
        ...
        elements.forEach(element => {
            ...
            if (enText && arText) {
                element.textContent = this.language === 'ar' ? arText : enText;
            }
        });
        ...
        // Update hero image for Arabic
        const heroImg = document.getElementById('hero-img');
        if (heroImg) {
            heroImg.src = this.language === 'ar' ? 'images/tablet-mockup-arabic.png' : 'images/tablet-mockup.png';
        }
    }
...
document.addEventListener('visibilitychange', () => {
    if (document.hidden) {
        // Page is hidden
        document.title = '👋 Come back to MARLN University CRM';
    } else {
        // Page is visible
        document.title = 'MARLN University CRM - Your University. Simplified.';
    }
});
